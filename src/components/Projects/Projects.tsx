  ...
  const [ebooks] = useState<EbookItem[]>([
    {
      ...
      title: "Ebook Java Versions",
      description: "Resumo curto do ebook sobre versões do Java publicado na branch feature/java-versions.",
    ...
    {
      id: "ebook-kubernetes",
      title: "Ebook Kubernetes",
      description: "Resumo curto do ebook sobre Kubernetes publicado na branch kubernetes.",
      ...
      tags: ["ebook", "kubernetes"],
      publishedAt: "2026-05-11",
    },
    {
      id: "ebook-main",
      title: "Ebook Principal",
      description: "Resumo curto do ebook principal publicado na branch main.",
